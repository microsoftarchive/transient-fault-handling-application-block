...
namespace Microsoft.Practices.EnterpriseLibrary.TransientFaultHandling.Tests
{
    ...
    public class GeneralRetryPolicyTests
    {
        ...
        public void TestNegativeRetryInterval()
        {
            ...
            {
                Assert.AreEqual("retryInterval", ex.ParamName, String.Format("A wrong argument has caused the {0} exception", ex.GetType().Name));
            }
        ...
        public void TestNegativeMaxBackoff()
        {
            ...
            {
                Assert.AreEqual("maxBackoff", ex.ParamName, String.Format("A wrong argument has caused the {0} exception", ex.GetType().Name));
            }
        ...
        public void TestNegativeDeltaBackoff()
        {
            ...
            {
                Assert.AreEqual("deltaBackoff", ex.ParamName, String.Format("A wrong argument has caused the {0} exception", ex.GetType().Name));
            }
